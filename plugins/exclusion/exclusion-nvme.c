...
/*
 * Mutating exclusion commands write under /etc/nvme/exclusions, which is
 * root-owned.  Fail early with a clear message rather than letting the write
...
/*
 * Validate all "exclusion = ..." lines in a file.
